...
pub const forms = .{
    struct {
        pub const encoding = .{
            opcodes.LSB.misc_16,
            Encoder.init(8, opcodes.Misc_16.b_imm),
            Encoder.init(16, Int(.imm, u32)),
        };
        pub const entry = b_imm;
    },
    ...
    struct {
        pub const encoding = .{
            opcodes.LSB.misc_16,
            Encoder.init(8, opcodes.Misc_16.b_imm_unaligned),
            Encoder.init_dont_care(16, @as(u8, 0)),
            Encoder.init(24, Int(.imm, u32)),
        };
        pub const entry = b_imm_unaligned;
    },
};

pub fn b_imm(c: *Cycle) void {
...
pub fn b_imm_unaligned(c: *Cycle) void {
