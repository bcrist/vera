...
pub fn Case_Insensitive_Enum_Map(comptime T: type, comptime options: Case_Insensitive_Enum_Map_Options, comptime extra_entries: anytype) type {
    ...
    return std.ComptimeStringMapWithEql(T, entries, std.ascii.eqlIgnoreCase);
}
