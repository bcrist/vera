...
pub const Type = union (enum) {
    ...
    pub fn reg(comptime width: u6, index: Register_Index, signedness: ?Signedness) Type {
        ...
        return .{ .raw = .{
            .base = @unionInit(Term_Type, field, .{
                .index = index,
...
pub const Term_Type = union (enum) {
    none,
    constant,
    reg8: Indexed_Register_Type,
    reg16: Indexed_Register_Type,
    reg32: Indexed_Register_Type,
    sr: Special_Register,
    ...
    pub fn param_kind(self: Term_Type) Parameter.Kind {
        return switch (self) {
            .none => .none,
            .constant => .constant,
            .reg8 => |reg| .{ .reg8 = reg.signedness },
            .reg16 => |reg| .{ .reg16 = reg.signedness },
            .reg32 => |reg| .{ .reg32 = reg.signedness },
            .sr => |sr| .{ .sr = sr },
        };
    }
...
pub const Type_Builder = struct {
    ...
    fn get_priority(t: Term_Type) u8 {
        ...
        return switch (t) {
            .none => 0,
            .constant => 1,
            .reg8 => |r| @as(u8, 0x10) + r.index,
            .reg16 => |r| @as(u8, 0x20) + r.index,
            .reg32 => |r| @as(u8, 0x30) + r.index,
